...
@SpringBootTest
public class RequestStageRespositoryTests {
	...
	public void AsaveTest() {
		...
		RequestStage stage = new RequestStage(null, "Foi comprado um novo laptop de marca HP e com 16 GB de RAM", new Date(), RequestState.CLOSED, request, owner);
	...
	public void getByIdTest() {
		...
		assertThat(stage.getDescripiton()).isEqualTo("Foi comprado um novo laptop de marca HP e com 16 GB de RAM");
	}
